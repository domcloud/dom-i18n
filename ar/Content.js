export default {
    ...
    hostNeedInvite: {
        ...
        hint: "مرحبًا 👋 للاستمتاع بالخطة المجانية لـ DOM Cloud، نحتاج إلى الوثوق بك إما عبر رمز دعوة أو ربط بحساب GitHub. رمز الدعوة يأتي من الشخص الذي يوصي لك بهذه المنصة.",
        hintBtn: "تأكيد!",
