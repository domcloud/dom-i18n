export default {
    ...
    hostLog: {
        ...
        logTypeUnitStdout: 'Unit Stdout Log',
        logTypeUnitStderr: 'Unit Stderr Log',
        ...
        logTypeUnitStdoutHint: 'This log contains Unit stdout logs for the current day',
        logTypeUnitStderrHint: 'This log contains Unit stderr logs for the current day',
