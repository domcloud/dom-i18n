export default {
    ...
    hostTransfer: {
        warn: `ATTENTION! Website transfer means moving it to another account. Once you transfer you will lose access to this hosting because it has changed hands!`,
        currentOwner: `Current owner: {0}`,
        hint: `Please enter the email of the account you wish to receive:`,
        disabled: `You cannot transfer this hosting while it's not active.`,
        action: `Transfer!`,
    },
    hostDelete: {
        warn: `ATTENTION! Host deletions are permanent and we can't reverse the action. Please be certain.`,
        hint: `Please enter your hosting username to agree to host deletion.`,
        action: `Delete!`,
    },
    hostCname: {
        disabled: `Changing Domain hosting is not available if it has not been paid or is currently using a Freedom plan.`,
        curHint: `Current domain name: `,
        hint: `You can change the main domain name hosting here. Enter the new domain name:`,
        warn: `Make sure that you have ownership of the domain and that you have routed the DNS records correctly.`,
        action: `Change domain name!`,
    },
    hostRename: {
        disabled: `Changing the host username is not available if you haven't paid or are currently using the Freedom plan.`,
        hint: `You can change your hosting username here. Enter the new username:`,
        warn: `If you change the username while using the default domain, the domain name will follow.`,
        action: `Rename!`,
    },
    hostCheck: {
