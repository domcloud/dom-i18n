export default {
    ...
    notification: {
        ...
        freeUserGuideHint: "Obrigado por nos escolher como sua plataforma de nuvem 🥳 Se ainda não o fez, experimente ler o nosso <a href=\"{0}\" target=\"_blank\">Guia de Introdução</a>. Quer a experiência completa? Experimente <a href=\"{1}\">atualizar seu plano</a> para remover o firewall da API, banners de domínio grátis e desbloquear <a href=\"{2}\" target=\"_blank\">mais recursos</a>!",
        lockedUserGuideTitle: "Bem-vindo a Bordo!",
        lockedUserGuideHint: "Obrigado por nos escolher como sua plataforma de nuvem 🥳 Crie seu primeiro site <a href=\"{0}\">aqui</a>. Pode ser solicitado que você vincule sua conta do GitHub para verificar esta conta. Você também pode <a href=\"{1}\">atualizar seu plano</a> para verificar instantaneamente sua conta junto com <a href=\"{2}\" target=\"_blank\">mais recursos</a> como uma conta assinante.",
        accountNoticeTitle: "⚠️ Sua conta pode ser suspensa",
        accountNoticeHint: "Sua conta foi suspensa por este motivo: {0}. Você pode <a href=\"{1}\">atualizar seu plano</a> para resolver este problema.",
    ...
    hostConnection: {
        ...
        pingNoWwwFix: "Configurar redirecionamento do subdomínio www.*",
        ...
        webInfiniteRedirectTitle: "O site possui redirecionamentos infinitos",
        webInfiniteRedirectContent: "Este site está atualmente atendendo solicitações HTTPS infinitas, pode já estar atrás de um proxy HTTPS.",
        webInfiniteRedirectFix: "Desativar redirecionamento HTTPS",
        webBadWwwTitle: "O subdomínio www.* não está acessível",
        webBadWwwContent: "O subdomínio www não está acessível ou está retornando erro.",
        webInsecureTitle: "O site está atendendo solicitações HTTP inseguras",
        webInsecureContent: "Este site não redireciona para o protocolo HTTPS, o que não é recomendado e pode causar problemas com cookies.",
        webInsecureContentFix: "Forçar redirecionamento HTTPS",
        webOkTitle: `Site OK`,
