export default {
    ...
    notification: {
        ...
        freeUserGuideHint: "Terima kasih telah memilih kami sebagai platform cloud Anda 🥳 Jika Anda belum melakukannya, cobalah membaca <a href=\"{0}\" target=\"_blank\">Panduan Memulai</a> kami. Butuh pengalaman penuh kami? Coba <a href=\"{1}\">tingkatkan paket Anda</a> untuk menghapus firewall API, banner domain gratis, dan membuka <a href=\"{2}\" target=\"_blank\">lebih banyak fitur</a>!",
        lockedUserGuideTitle: "Selamat Datang!",
        lockedUserGuideHint: "Terima kasih telah memilih kami sebagai platform cloud Anda 🥳 Buat situs web pertama Anda <a href=\"{0}\">di sini</a>. Anda mungkin diminta untuk menautkan akun GitHub Anda untuk memverifikasi akun ini. Anda juga bisa langsung <a href=\"{1}\">meningkatkan paket Anda</a> untuk memverifikasi akun Anda sekaligus dengan <a href=\"{2}\" target=\"_blank\">lebih banyak fitur</a> sebagai akun berlangganan.",
        accountNoticeTitle: "⚠️ Akun Anda Mungkin Ditangguhkan",
        accountNoticeHint: "Akun Anda ditangguhkan karena alasan ini: {0}. Anda dapat <a href=\"{1}\">meningkatkan paket Anda</a> untuk menyelesaikan masalah ini.",
    ...
    hostConnection: {
        ...
        pingNoWwwFix: "Atur pengalihan subdomain www.*",
        ...
        pingNoHttpsFix: "Pasang sertifikat HTTPS",
        ...
        webInfiniteRedirectTitle: "Website memiliki pengalihan tak terbatas",
        webInfiniteRedirectContent: "Website ini saat ini melayani permintaan HTTPS tak terbatas, mungkin sudah berada di belakang proxy HTTPS.",
        webInfiniteRedirectFix: "Nonaktifkan pengalihan HTTPS",
        webBadWwwTitle: "Subdomain www.* tidak dapat diakses",
        webBadWwwContent: "Subdomain www tidak dapat diakses atau mengembalikan kesalahan.",
        webInsecureTitle: "Website melayani permintaan HTTP tidak aman",
        webInsecureContent: "Website ini tidak mengalihkan ke protokol HTTPS, ini tidak direkomendasikan dan dapat menyebabkan masalah cookie.",
        webInsecureContentFix: "Paksa pengalihan HTTPS",
    ...
    hostServer: {
        disabled: `Anda tidak dapat mengubah wilayah server ketika situs web ini tidak aktif.`,
        hint: `Anda dapat memindahkan situs web Anda ke server cloud lain atau server self-hosted di sini. Pilih server baru:`,
        warn: `Ini akan melakukan backup, menghapus, lalu memulihkan situs web ini. Hal ini juga dapat membuat situs web Anda sementara tidak dapat diakses karena perubahan alamat IP!`,
        member: `Anggota tidak dapat mengubah wilayah server situs web ini.`,
        upgrade: `Memindahkan situs web ini ke server lain memerlukan fitur backup, Anda perlu upgrade.`,
        action: `Pindahkan ke server ini!`,
    },    
    hostCheck: {
        ...
        'valid_with_note': `Domain ini akan dapat diresolusi setelah konfigurasi tambahan ditambahkan secara otomatis untuk Anda`,
        'incorrect': 'Rekam A+AAAA/CNAME ke domain ini salah, harap konfigurasi terlebih dahulu sebelum melanjutkan.',
        'missing': 'Rekam A+AAAA/CNAME ke domain ini tidak ada, harap konfigurasi terlebih dahulu sebelum melanjutkan.',
        'loading': '...',
        'retrying': '...',
    },
    domain: {
