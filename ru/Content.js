export default {
    ...
    welcome: {
        title: `Добро пожаловать в {0}! 🎉`,
        description: ` <p>Привет, {0}</p>
        <p>
          Спасибо, что присоединились к {1}, чтобы добиться свободы веб-разработчиков в Интернете!
        </p>
        <p>
    ...
    notification: {
        ...
        freeUserGuideHint: "Спасибо, что выбрали нас в качестве вашей облачной платформы 🥳 Если вы ещё этого не сделали, попробуйте прочитать наше <a href=\"{0}\" target=\"_blank\">Руководство для Начинающих</a>. Хотите полный доступ? Попробуйте <a href=\"{1}\">обновить свой план</a>, чтобы удалить API-файрвол, баннеры бесплатного домена и разблокировать <a href=\"{2}\" target=\"_blank\">больше функций</a>!",
        lockedUserGuideTitle: "Добро пожаловать!",
        lockedUserGuideHint: "Спасибо, что выбрали нас в качестве вашей облачной платформы 🥳 Создайте свой первый веб-сайт <a href=\"{0}\">здесь</a>. Возможно, вам потребуется связать свою учетную запись GitHub для подтверждения. Вы также можете <a href=\"{1}\">обновить свой план</a>, чтобы мгновенно подтвердить свою учетную запись и получить <a href=\"{2}\" target=\"_blank\">дополнительные функции</a> как подписчик.",
        accountNoticeTitle: "⚠️ Ваша учетная запись может быть заблокирована",
        accountNoticeHint: "Ваша учетная запись заблокирована по следующей причине: {0}. Вы можете <a href=\"{1}\">обновить свой план</a>, чтобы решить эту проблему.",
    ...
    hostNeedInvite: {
        title: "Требуется код приглашения",
        hint: "Привет 👋 Чтобы воспользоваться нашим бесплатным планом, нам нужно доверять вам либо через код приглашения, либо через ссылку на учетную запись GitHub. Код приглашения исходит от человека, который порекомендовал вам эту платформу.",
        hintBtn: "Разрешить!",
        hintGitHub: "В качестве альтернативы вы можете привязать свою учетную запись GitHub. Ваша учетная запись GitHub должна <b>быть старше шести месяцев и иметь одного или более подписчиков</b>.",
        githubFail: "Извините! Ваша привязанная учетная запись GitHub пока не заслуживает доверия. Вы можете попробовать снова привязать правильную учетную запись, которая соответствует нашим требованиям.",
        altHint: "Если вы хотите избежать этого шага, вы можете <a href=\"{0}\">обновить хотя бы один раз</a>. Обновление подтверждает, что вы действительно человек и вам можно доверять без кода приглашения или привязки дополнительных учетных записей 😄."
    },
    hostCreate: {
