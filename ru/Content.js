export default {
    ...
    hostNeedInvite: {
        ...
        hint: "Здравствуйте 👋 Чтобы пользоваться бесплатным планом DOM Cloud, мы должны доверять вам либо через код приглашения, либо через привязку учетной записи GitHub. Код приглашения предоставляется тем, кто рекомендует вам эту платформу.",
        hintBtn: "Разрешить!",
