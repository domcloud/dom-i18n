export default {
    ...
    notification: {
        ...
        freeUserGuideHint: "클라우드 플랫폼으로 저희를 선택해 주셔서 감사합니다 🥳 아직 하지 않으셨다면, <a href=\"{0}\" target=\"_blank\">시작 가이드</a>를 읽어보세요. 최고의 경험을 원하신다면 <a href=\"{1}\">계획을 업그레이드</a>하여 API 방화벽, 무료 도메인 배너를 제거하고 <a href=\"{2}\" target=\"_blank\">더 많은 기능</a>을 잠금 해제하세요!",
        lockedUserGuideTitle: "환영합니다!",
        lockedUserGuideHint: "클라우드 플랫폼으로 저희를 선택해 주셔서 감사합니다 🥳 첫 번째 웹사이트를 <a href=\"{0}\">여기에서 만드세요</a>. 계정을 확인하려면 GitHub 계정을 연결하라는 요청을 받을 수 있습니다. <a href=\"{1}\">계획을 업그레이드</a>하여 즉시 계정을 확인하고 <a href=\"{2}\" target=\"_blank\">더 많은 기능</a>을 구독 계정으로 이용할 수 있습니다.",
        accountNoticeTitle: "⚠️ 계정이 정지될 수 있습니다",
        accountNoticeHint: "계정이 다음 이유로 정지되었습니다: {0}. 문제를 해결하려면 <a href=\"{1}\">계획을 업그레이드</a>하세요.",
        empty: "여기에 표시할 내용이 없습니다"
    },
    ...
    hostConnection: {
        ...
        webInfiniteRedirectTitle: "웹사이트가 무한 리디렉션을 제공합니다",
        webInfiniteRedirectContent: "이 웹사이트는 현재 무한 HTTPS 요청을 제공하고 있으며, 이미 HTTPS 프록시 뒤에 있을 수 있습니다.",
        webInfiniteRedirectFix: "HTTPS 리디렉션 비활성화",
        webBadWwwTitle: "www.* 하위 도메인에 접근할 수 없습니다",
        webBadWwwContent: "www 하위 도메인이 접근 불가능하거나 오류를 반환하고 있습니다.",
        webInsecureTitle: "웹사이트가 안전하지 않은 HTTP 요청을 제공합니다",
        webInsecureContent: "이 웹사이트는 HTTPS 프로토콜로 리디렉션되지 않습니다. 권장되지 않으며 쿠키 문제를 일으킬 수 있습니다.",
        webInsecureContentFix: "HTTPS 리디렉션 강제",
        webOkTitle: `웹사이트 정상`,
