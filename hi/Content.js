export default {
    ...
    welcome: {
        title: `{0} में आपका स्वागत है! 🎉`,
        description: ` <p>नमस्ते, {0}</p>
        <p>
          इंटरनेट पर वेब डेवलपर्स की स्वतंत्रता प्राप्त करने के लिए {1} में शामिल होने के लिए धन्यवाद!
        </p>
        <p>
    ...
    notification: {
        ...
        freeUserGuideHint: "हमें अपना क्लाउड प्लेटफ़ॉर्म चुनने के लिए धन्यवाद 🥳 यदि आपने अभी तक नहीं किया है, तो हमारा <a href=\"{0}\" target=\"_blank\">शुरुआती गाइड</a> पढ़ने का प्रयास करें। हमारा पूरा अनुभव चाहिए? <a href=\"{1}\">अपनी योजना को अपग्रेड करें</a> API फ़ायरवॉल, मुफ़्त डोमेन बैनर हटाने और <a href=\"{2}\" target=\"_blank\">अधिक सुविधाओं</a> को अनलॉक करने के लिए!",
        lockedUserGuideTitle: "स्वागत है!",
        lockedUserGuideHint: "हमें अपना क्लाउड प्लेटफ़ॉर्म चुनने के लिए धन्यवाद 🥳 अपनी पहली वेबसाइट <a href=\"{0}\">यहां</a> बनाएं। आपको इस खाते को सत्यापित करने के लिए अपना GitHub खाता लिंक करने के लिए कहा जा सकता है। आप तुरंत सत्यापन के लिए <a href=\"{1}\">अपनी योजना को अपग्रेड करें</a> और <a href=\"{2}\" target=\"_blank\">अधिक सुविधाओं</a> को सब्सक्राइबिंग खाते के रूप में प्राप्त करें।",
        accountNoticeTitle: "⚠️ आपका खाता निलंबित हो सकता है",
        accountNoticeHint: "आपका खाता इस कारण से निलंबित है: {0}. आप <a href=\"{1}\">अपनी योजना को अपग्रेड करें</a> समस्या को हल करने के लिए।",
        empty: "यहां कुछ भी नहीं है"
    },
    ...
    hostNeedInvite: {
        title: "आमंत्रण कोड आवश्यक है",
        hint: "नमस्ते 👋 हमारी निःशुल्क योजना का आनंद लेने के लिए, हमें आप पर या तो आमंत्रण कोड या GitHub खाते के लिंक के माध्यम से भरोसा करना होगा। आमंत्रण कोड उस व्यक्ति से आता है जिसने आपको इस प्लेटफ़ॉर्म की अनुशंसा की है।",
        hintBtn: "अनुमति दें!",
        hintGitHub: "वैकल्पिक रूप से, आप अपना GitHub खाता लिंक कर सकते हैं। आपका GitHub खाता <b>छह महीने या उससे अधिक पुराना होना चाहिए और इसमें एक या अधिक अनुयायी होने चाहिए</b>।",
        githubFail: "क्षमा करें! आपका लिंक किया गया GitHub खाता अभी तक भरोसेमंद नहीं है। आप हमारी आवश्यकताओं को पूरा करने वाले सही खाते को फिर से लिंक करने का प्रयास कर सकते हैं।",
        altHint: "यदि आप इस चरण को छोड़ना चाहते हैं, तो आप <a href=\"{0}\">कम से कम एक बार अपग्रेड कर सकते हैं</a>। अपग्रेड यह पुष्टि करता है कि आप वास्तव में मानव हैं और बिना आमंत्रण कोड या अतिरिक्त खातों को लिंक किए भरोसेमंद हैं 😄।"
    },
    hostCreate: {
